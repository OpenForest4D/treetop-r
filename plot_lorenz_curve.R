...
# Define the plot_lorenz_curve function with CHM path as input
plot_lorenz_curve <- function(chm_path, output_file = "lorenz_curve.png", width = 800, height = 600, res = 100,
                              window_size = 5, height_threshold = 1.37) {
